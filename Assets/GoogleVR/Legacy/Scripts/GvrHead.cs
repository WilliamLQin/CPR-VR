...
public class GvrHead : MonoBehaviour {
  ...
  public Transform alternativeHead;
...
//			alternativeHead.position = transform.position;
//			alternativeHead.localPosition = transform.localPosition;

			alternativeHead.rotation = transform.rotation;
			alternativeHead.localRotation = transform.localRotation;
